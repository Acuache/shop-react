...
export const AdminSidebar: React.FC<SidebarProps> = ({ isCollapsed, onToggle }) => {
  ...
  const isActiveRoute = (to: String) => {
    ...
    if (pathname.includes('/admin/products/new') && to === '/admin/products') return true
    return pathname === to
  }
  ...
  return (
    <div className={`bg-white border-r border-gray-200 transition-all duration-300 ease-in-out ${isCollapsed ? 'w-19' : 'w-64'} flex flex-col`}>
      {/* Header */}
