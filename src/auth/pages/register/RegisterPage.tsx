...
export const RegisterPage = () => {
  ...
  const handleRegister = async (event: React.SubmitEvent<HTMLFormElement>) => {
    ...
    toast.error('La cuenta ya ha sido creado por otro usuario')
    setIsPosting(false)
  }
  return (
    <div className={"flex flex-col gap-6"} >
          ...
          <form className="p-6 md:p-8" onSubmit={handleRegister}>
            <div className="flex flex-col gap-6">
              ...
              <div className="text-center text-sm">
                ...
                <Link to="/auth/login" className="underline underline-offset-4 ml-2">
                  Ingresa ahora
                </Link>
              </div>
            </div>
      ...
      <div className="text-balance text-center text-xs text-muted-foreground [&_a]:underline [&_a]:underline-offset-4 hover:[&_a]:text-primary">
        Haciendo click, estás de acuerdo con <a href="#">términos y condiciones</a> y <a href="#">politicas de uso</a>.
      </div>
    </div>
  )
}